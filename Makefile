...
SRC = src/extract.c src/files.c src/utils.c src/list.c src/aes.c \

OBJ = $(SRC:.c=.o)
all: $(XTR) $(UNXTR)

$(UNXTR): $(OBJ)
	gcc $(CFLAGS) src/utils.o src/extract.o src/list.o src/aes.o -o $(UNXTR)

$(XTR): $(OBJ)
	gcc $(CFLAGS) src/utils.o src/files.o src/aes.o -o $(XTR)
